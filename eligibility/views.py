    ...
    if request.method =='POST': #if the form has been filled
        ...
        if form.is_valid(): # Data has gone through all the checks
            try:
                ...
                return render(request,'eligibility/check_eligibility.html',{'message':'Clients does not exist','form':form})
...
def index(request):
    form = IdForm()
    return render(request,'eligibility/check_eligibility.html',{'form':form})
